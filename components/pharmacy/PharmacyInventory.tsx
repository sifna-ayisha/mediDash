...
const PharmacyInventory: React.FC<PharmacyInventoryProps> = ({ inventory, setInventory, addNotification }) => {
    ...
    const handleSave = (item: InventoryItem) => {
        ...
        if (currentStatus === StockStatus.LowStock && previousStatus !== StockStatus.LowStock) {
            addNotification(NotificationType.LowStock, `${item.name} is low on stock (${item.stock} units left).`, 'Reorder');
        }
